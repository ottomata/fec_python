...
class DebtsApi(object):
    ...
    def schedules_schedule_d_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'min_date', 'line_number', 'nature_of_debt', 'committee_id', 'min_payment_period', 'max_date', 'creditor_debtor_name', 'sort_nulls_last', 'sort', 'page', 'max_payment_period', 'image_number', 'max_amount', 'max_amount_incurred', 'min_amount', 'min_image_number', 'per_page', 'min_amount_incurred', 'candidate_id', 'max_image_number']  # noqa: E501
    ...
    def schedules_schedule_d_sub_id_get_with_http_info(self, api_key, sub_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sub_id', 'sort_null_only', 'sort_hide_null', 'page', 'sort', 'per_page', 'sort_nulls_last']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
