...
class CommunicationCostApi(object):
    ...
    def committee_committee_id_communication_costs_by_candidate_get_with_http_info(self, api_key, committee_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_id', 'sort_null_only', 'sort_hide_null', 'state', 'sort', 'page', 'district', 'support_oppose', 'election_full', 'office', 'per_page', 'sort_nulls_last', 'cycle', 'candidate_id']  # noqa: E501
    ...
    def communication_costs_aggregates_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'per_page', 'sort_hide_null', 'sort', 'page', 'committee_id', 'support_oppose_indicator', 'sort_nulls_last', 'cycle', 'candidate_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def communication_costs_by_candidate_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'state', 'sort', 'page', 'district', 'support_oppose', 'election_full', 'office', 'per_page', 'sort_nulls_last', 'cycle', 'candidate_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def communication_costs_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'min_date', 'line_number', 'committee_id', 'support_oppose_indicator', 'max_date', 'sort_nulls_last', 'page', 'sort', 'image_number', 'max_amount', 'min_amount', 'min_image_number', 'per_page', 'candidate_id', 'max_image_number']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
