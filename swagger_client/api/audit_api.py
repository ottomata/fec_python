...
class AuditApi(object):
    ...
    def audit_case_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'committee_designation', 'audit_id', 'sub_category_id', 'committee_type', 'committee_id', 'sort_nulls_last', 'qq', 'q', 'sort', 'page', 'primary_category_id', 'audit_case_id', 'max_election_cycle', 'min_election_cycle', 'per_page', 'cycle', 'candidate_id']  # noqa: E501
    ...
    def audit_category_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'primary_category_name', 'sort_hide_null', 'page', 'sort', 'primary_category_id', 'per_page', 'sort_nulls_last']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
