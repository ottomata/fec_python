...
class LegalApi(object):
    ...
    def legal_search_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'case_max_close_date', 'case_min_close_date', 'case_document_category', 'af_min_fd_date', 'af_max_rtb_date', 'case_min_open_date', 'af_committee_id', 'ao_entity_name', 'af_rtb_fine_amount', 'af_fd_fine_amount', 'q', 'case_dispositions', 'ao_max_issue_date', 'type', 'ao_regulatory_citation', 'ao_is_pending', 'case_respondents', 'af_max_fd_date', 'ao_requestor_type', 'ao_max_request_date', 'ao_citation_require_all', 'ao_statutory_citation', 'case_election_cycles', 'ao_no', 'ao_status', 'ao_category', 'ao_min_issue_date', 'ao_name', 'case_max_open_date', 'from_hit', 'ao_requestor', 'case_no', 'af_min_rtb_date', 'af_report_year', 'hits_returned', 'af_name', 'ao_min_request_date']  # noqa: E501
