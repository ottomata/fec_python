...
class FilingsApi(object):
    ...
    def candidate_candidate_id_filings_get_with_http_info(self, api_key, candidate_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'candidate_id', 'filer_type', 'sort_null_only', 'form_type', 'sort_hide_null', 'state', 'is_amended', 'committee_type', 'district', 'most_recent', 'sort_nulls_last', 'beginning_image_number', 'form_category', 'report_type', 'party', 'report_year', 'min_receipt_date', 'sort', 'amendment_indicator', 'page', 'document_type', 'file_number', 'max_receipt_date', 'request_type', 'office', 'per_page', 'cycle', 'primary_general_indicator']  # noqa: E501
    ...
    def committee_committee_id_filings_get_with_http_info(self, api_key, committee_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_id', 'filer_type', 'sort_null_only', 'form_type', 'sort_hide_null', 'state', 'is_amended', 'committee_type', 'district', 'most_recent', 'sort_nulls_last', 'beginning_image_number', 'form_category', 'report_type', 'party', 'report_year', 'min_receipt_date', 'sort', 'amendment_indicator', 'page', 'document_type', 'file_number', 'max_receipt_date', 'request_type', 'office', 'per_page', 'cycle', 'primary_general_indicator']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def filings_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'filer_type', 'sort_null_only', 'form_type', 'sort_hide_null', 'state', 'is_amended', 'committee_type', 'district', 'most_recent', 'committee_id', 'sort_nulls_last', 'beginning_image_number', 'form_category', 'report_type', 'party', 'report_year', 'min_receipt_date', 'sort', 'amendment_indicator', 'page', 'document_type', 'file_number', 'max_receipt_date', 'request_type', 'office', 'per_page', 'cycle', 'candidate_id', 'primary_general_indicator']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def operations_log_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'max_coverage_end_date', 'form_type', 'sort_hide_null', 'max_transaction_data_complete_date', 'candidate_committee_id', 'min_coverage_end_date', 'min_transaction_data_complete_date', 'beginning_image_number', 'sort_nulls_last', 'report_type', 'report_year', 'min_receipt_date', 'status_num', 'sort', 'amendment_indicator', 'page', 'max_receipt_date', 'per_page']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
