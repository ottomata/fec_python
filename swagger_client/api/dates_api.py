...
class DatesApi(object):
    ...
    def calendar_dates_export_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'description', 'min_start_date', 'max_end_date', 'renderer', 'max_start_date', 'min_end_date', 'per_page', 'sort_nulls_last', 'calendar_category_id', 'summary', 'event_id']  # noqa: E501
    ...
    def calendar_dates_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'description', 'min_start_date', 'max_end_date', 'max_start_date', 'min_end_date', 'per_page', 'sort_nulls_last', 'calendar_category_id', 'summary', 'event_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def election_dates_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'max_primary_general_date', 'sort_null_only', 'sort_hide_null', 'min_create_date', 'min_update_date', 'election_year', 'election_state', 'max_election_date', 'election_type_id', 'election_district', 'office_sought', 'sort_nulls_last', 'sort', 'page', 'election_party', 'min_primary_general_date', 'max_create_date', 'max_update_date', 'per_page', 'min_election_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def reporting_dates_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'min_update_date', 'min_create_date', 'page', 'min_due_date', 'sort', 'max_due_date', 'max_create_date', 'max_update_date', 'per_page', 'sort_nulls_last', 'report_type', 'report_year']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
