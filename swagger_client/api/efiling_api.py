...
class EfilingApi(object):
    ...
    def efile_filings_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'min_receipt_date', 'sort_hide_null', 'sort', 'page', 'file_number', 'committee_id', 'max_receipt_date', 'per_page', 'sort_nulls_last']  # noqa: E501
