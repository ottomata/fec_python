...
class FinancialApi(object):
    ...
    def committee_committee_id_reports_get_with_http_info(self, api_key, committee_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_id', 'sort_null_only', 'max_debts_owed_expenditures', 'sort_hide_null', 'is_amended', 'max_cash_on_hand_end_period_amount', 'min_independent_expenditures', 'min_debts_owed_amount', 'min_disbursements_amount', 'sort_nulls_last', 'beginning_image_number', 'min_party_coordinated_expenditures', 'report_type', 'max_disbursements_amount', 'max_total_contributions', 'sort', 'max_party_coordinated_expenditures', 'type', 'min_total_contributions', 'min_cash_on_hand_end_period_amount', 'page', 'min_receipts_amount', 'max_independent_expenditures', 'max_receipts_amount', 'per_page', 'year', 'cycle', 'candidate_id']  # noqa: E501
    ...
    def committee_committee_id_totals_get_with_http_info(self, api_key, committee_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_id', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'type', 'per_page', 'sort_nulls_last', 'cycle', 'designation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def elections_get(self, office, cycle, api_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.elections_get(office, cycle, api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.elections_get_with_http_info(office, cycle, api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.elections_get_with_http_info(office, cycle, api_key, **kwargs)  # noqa: E501
            return data

    def elections_get_with_http_info(self, office, cycle, api_key, **kwargs):  # noqa: E501
        """elections_get  # noqa: E501

         Look at the top-level financial information for all candidates running for the same office.  Choose a 2-year cycle, and `house`, `senate` or `presidential`.  If you are looking for a Senate seat, you will need to select the state using a two-letter abbreviation.  House races require state and a two-digit district number.  Since this endpoint reflects financial information, it will only have candidates once they file financial reporting forms. Query the `/candidates` endpoint to see an up to date list of all the candidates that filed to run for a particular seat.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.elections_get_with_http_info(office, cycle, api_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['office', 'cycle', 'api_key', 'sort_null_only', 'sort_hide_null', 'state', 'sort', 'page', 'district', 'election_full', 'per_page', 'sort_nulls_last']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def elections_search_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'state', 'page', 'sort', 'district', 'office', 'per_page', 'sort_nulls_last', 'cycle', 'zip']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def elections_summary_get(self, office, cycle, api_key, **kwargs):  # noqa: E501
        """elections_summary_get  # noqa: E501

         List elections by cycle, office, state, and district.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.elections_summary_get(office, cycle, api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.elections_summary_get_with_http_info(office, cycle, api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.elections_summary_get_with_http_info(office, cycle, api_key, **kwargs)  # noqa: E501
            return data

    def elections_summary_get_with_http_info(self, office, cycle, api_key, **kwargs):  # noqa: E501
        """elections_summary_get  # noqa: E501

         List elections by cycle, office, state, and district.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.elections_summary_get_with_http_info(office, cycle, api_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['office', 'cycle', 'api_key', 'election_full', 'state', 'district']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def reports_committee_type_get_with_http_info(self, api_key, committee_type, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_type', 'filer_type', 'sort_null_only', 'max_debts_owed_expenditures', 'sort_hide_null', 'is_amended', 'min_independent_expenditures', 'sort_nulls_last', 'beginning_image_number', 'max_total_contributions', 'sort', 'max_party_coordinated_expenditures', 'type', 'amendment_indicator', 'min_receipts_amount', 'max_receipt_date', 'per_page', 'year', 'candidate_id', 'min_cash_on_hand_end_period_amount', 'max_cash_on_hand_end_period_amount', 'min_debts_owed_amount', 'min_disbursements_amount', 'most_recent', 'committee_id', 'min_party_coordinated_expenditures', 'report_type', 'min_receipt_date', 'min_total_contributions', 'page', 'max_independent_expenditures', 'max_receipts_amount', 'max_disbursements_amount', 'cycle']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def totals_by_entity_get(self, cycle, api_key, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.totals_by_entity_get_with_http_info(cycle, api_key, **kwargs)  # noqa: E501
            return data
    ...
    def totals_by_entity_get_with_http_info(self, cycle, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['cycle', 'api_key', 'sort_null_only', 'sort_hide_null', 'page', 'sort', 'per_page', 'sort_nulls_last']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def totals_committee_type_get_with_http_info(self, api_key, committee_type, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_type', 'sort_null_only', 'sort_hide_null', 'page', 'committee_type_full', 'sort', 'committee_designation_full', 'committee_id', 'per_page', 'sort_nulls_last', 'cycle']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
