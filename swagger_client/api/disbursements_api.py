...
class DisbursementsApi(object):
    ...
    def schedules_schedule_b_by_purpose_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'committee_id', 'per_page', 'purpose', 'cycle', 'sort_nulls_last']  # noqa: E501
    ...
    def schedules_schedule_b_by_recipient_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'committee_id', 'recipient_name', 'per_page', 'sort_nulls_last', 'cycle']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def schedules_schedule_b_by_recipient_id_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'recipient_id', 'committee_id', 'per_page', 'sort_nulls_last', 'cycle']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def schedules_schedule_b_efile_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'per_page', 'sort_hide_null', 'sort', 'page', 'image_number', 'recipient_city', 'committee_id', 'max_amount', 'min_amount', 'min_date', 'max_date', 'recipient_state', 'sort_nulls_last', 'disbursement_description']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def schedules_schedule_b_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'min_date', 'line_number', 'max_image_number', 'spender_committee_type', 'committee_id', 'recipient_committee_id', 'max_date', 'recipient_state', 'last_disbursement_date', 'spender_committee_designation', 'last_disbursement_amount', 'sort', 'last_index', 'two_year_transaction_period', 'image_number', 'max_amount', 'min_amount', 'recipient_name', 'spender_committee_org_type', 'min_image_number', 'per_page', 'recipient_city', 'disbursement_purpose_category', 'disbursement_description']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def schedules_schedule_b_sub_id_get_with_http_info(self, api_key, sub_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sub_id', 'sort_null_only', 'sort_hide_null', 'min_date', 'line_number', 'max_image_number', 'spender_committee_type', 'committee_id', 'recipient_committee_id', 'max_date', 'recipient_state', 'last_disbursement_date', 'spender_committee_designation', 'last_disbursement_amount', 'sort', 'last_index', 'two_year_transaction_period', 'image_number', 'max_amount', 'min_amount', 'recipient_name', 'spender_committee_org_type', 'min_image_number', 'per_page', 'recipient_city', 'disbursement_purpose_category', 'disbursement_description']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
