...
class CommitteeApi(object):
    ...
    def candidate_candidate_id_committees_get_with_http_info(self, api_key, candidate_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'candidate_id', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'committee_type', 'filing_frequency', 'organization_type', 'per_page', 'year', 'cycle', 'designation', 'sort_nulls_last']  # noqa: E501
    ...
    def candidate_candidate_id_committees_history_cycle_get_with_http_info(self, api_key, cycle, candidate_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'cycle', 'candidate_id', 'sort_null_only', 'sort_hide_null', 'page', 'sort', 'election_full', 'per_page', 'sort_nulls_last', 'designation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def candidate_candidate_id_committees_history_get_with_http_info(self, api_key, candidate_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'candidate_id', 'sort_null_only', 'sort_hide_null', 'page', 'sort', 'election_full', 'per_page', 'sort_nulls_last', 'designation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def committee_committee_id_get_with_http_info(self, api_key, committee_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_id', 'sort_null_only', 'sort_hide_null', 'sort', 'page', 'committee_type', 'filing_frequency', 'organization_type', 'per_page', 'year', 'cycle', 'designation', 'sort_nulls_last']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def committee_committee_id_history_cycle_get_with_http_info(self, api_key, committee_id, cycle, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_id', 'cycle', 'sort_null_only', 'sort_hide_null', 'page', 'sort', 'election_full', 'per_page', 'sort_nulls_last', 'designation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def committee_committee_id_history_get_with_http_info(self, api_key, committee_id, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'committee_id', 'sort_null_only', 'sort_hide_null', 'page', 'sort', 'election_full', 'per_page', 'sort_nulls_last', 'designation']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def committees_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'state', 'committee_type', 'filing_frequency', 'committee_id', 'max_last_f1_date', 'sort_nulls_last', 'designation', 'party', 'max_first_file_date', 'q', 'sort', 'page', 'min_first_file_date', 'organization_type', 'treasurer_name', 'per_page', 'year', 'cycle', 'candidate_id', 'min_last_f1_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
