...
class FilerResourcesApi(object):
    ...
    def rad_analyst_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'max_assignment_update_date', 'page', 'title', 'sort', 'analyst_id', 'analyst_short_id', 'committee_id', 'telephone_ext', 'email', 'min_assignment_update_date', 'per_page', 'name', 'sort_nulls_last']  # noqa: E501
    ...
    def state_election_office_get(self, state, api_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.state_election_office_get(state, api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.state_election_office_get_with_http_info(state, api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.state_election_office_get_with_http_info(state, api_key, **kwargs)  # noqa: E501
            return data

    def state_election_office_get_with_http_info(self, state, api_key, **kwargs):  # noqa: E501
        """state_election_office_get  # noqa: E501

         State laws and procedures govern elections for state or local offices as well as how candidates appear on election ballots. Contact the appropriate state election office for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.state_election_office_get_with_http_info(state, api_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['state', 'api_key', 'sort_null_only', 'sort_hide_null', 'page', 'sort', 'per_page', 'sort_nulls_last']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
