...
class LoansApi(object):
    ...
    def schedules_schedule_c_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'line_number', 'committee_id', 'max_payment_to_date', 'sort_nulls_last', 'min_incurred_date', 'loan_source_name', 'min_payment_to_date', 'sort', 'page', 'last_index', 'image_number', 'max_amount', 'min_amount', 'min_image_number', 'max_incurred_date', 'candidate_name', 'per_page', 'max_image_number']  # noqa: E501
