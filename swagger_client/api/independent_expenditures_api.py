...
class IndependentExpendituresApi(object):
    ...
    def schedules_schedule_e_by_candidate_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'state', 'sort', 'page', 'district', 'support_oppose', 'election_full', 'committee_id', 'office', 'per_page', 'sort_nulls_last', 'cycle', 'candidate_id']  # noqa: E501
    ...
    def schedules_schedule_e_efile_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'sort_null_only', 'sort_hide_null', 'candidate_office_state', 'payee_name', 'committee_id', 'most_recent', 'spender_name', 'support_oppose_indicator', 'sort_nulls_last', 'max_filed_date', 'candidate_office', 'candidate_search', 'sort', 'page', 'min_filed_date', 'max_expenditure_amount', 'is_notice', 'image_number', 'filing_form', 'min_expenditure_amount', 'max_expenditure_date', 'candidate_office_district', 'max_dissemination_date', 'candidate_party', 'min_expenditure_date', 'per_page', 'min_dissemination_date', 'candidate_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def schedules_schedule_e_get_with_http_info(self, api_key, **kwargs):  # noqa: E501
        ...
        all_params = ['api_key', 'min_filing_date', 'sort_null_only', 'sort_hide_null', 'line_number', 'candidate_office_state', 'payee_name', 'last_expenditure_date', 'support_oppose_indicator', 'max_date', 'sort_nulls_last', 'candidate_office', 'sort', 'max_amount', 'last_expenditure_amount', 'candidate_party', 'per_page', 'cycle', 'candidate_id', 'max_image_number', 'min_date', 'last_support_oppose_indicator', 'committee_id', 'most_recent', 'last_office_total_ytd', 'is_notice', 'last_index', 'max_filing_date', 'min_amount', 'candidate_office_district', 'min_image_number', 'max_dissemination_date', 'image_number', 'min_dissemination_date', 'filing_form']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
