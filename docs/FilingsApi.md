...
> FilingsPage candidate_candidate_id_filings_get(api_key, candidate_id, filer_type=filer_type, sort_null_only=sort_null_only, form_type=form_type, sort_hide_null=sort_hide_null, state=state, is_amended=is_amended, committee_type=committee_type, district=district, most_recent=most_recent, sort_nulls_last=sort_nulls_last, beginning_image_number=beginning_image_number, form_category=form_category, report_type=report_type, party=party, report_year=report_year, min_receipt_date=min_receipt_date, sort=sort, amendment_indicator=amendment_indicator, page=page, document_type=document_type, file_number=file_number, max_receipt_date=max_receipt_date, request_type=request_type, office=office, per_page=per_page, cycle=cycle, primary_general_indicator=primary_general_indicator)
...
try:
    api_response = api_instance.candidate_candidate_id_filings_get(api_key, candidate_id, filer_type=filer_type, sort_null_only=sort_null_only, form_type=form_type, sort_hide_null=sort_hide_null, state=state, is_amended=is_amended, committee_type=committee_type, district=district, most_recent=most_recent, sort_nulls_last=sort_nulls_last, beginning_image_number=beginning_image_number, form_category=form_category, report_type=report_type, party=party, report_year=report_year, min_receipt_date=min_receipt_date, sort=sort, amendment_indicator=amendment_indicator, page=page, document_type=document_type, file_number=file_number, max_receipt_date=max_receipt_date, request_type=request_type, office=office, per_page=per_page, cycle=cycle, primary_general_indicator=primary_general_indicator)
    pprint(api_response)
...
> FilingsPage committee_committee_id_filings_get(api_key, committee_id, filer_type=filer_type, sort_null_only=sort_null_only, form_type=form_type, sort_hide_null=sort_hide_null, state=state, is_amended=is_amended, committee_type=committee_type, district=district, most_recent=most_recent, sort_nulls_last=sort_nulls_last, beginning_image_number=beginning_image_number, form_category=form_category, report_type=report_type, party=party, report_year=report_year, min_receipt_date=min_receipt_date, sort=sort, amendment_indicator=amendment_indicator, page=page, document_type=document_type, file_number=file_number, max_receipt_date=max_receipt_date, request_type=request_type, office=office, per_page=per_page, cycle=cycle, primary_general_indicator=primary_general_indicator)
...
try:
    api_response = api_instance.committee_committee_id_filings_get(api_key, committee_id, filer_type=filer_type, sort_null_only=sort_null_only, form_type=form_type, sort_hide_null=sort_hide_null, state=state, is_amended=is_amended, committee_type=committee_type, district=district, most_recent=most_recent, sort_nulls_last=sort_nulls_last, beginning_image_number=beginning_image_number, form_category=form_category, report_type=report_type, party=party, report_year=report_year, min_receipt_date=min_receipt_date, sort=sort, amendment_indicator=amendment_indicator, page=page, document_type=document_type, file_number=file_number, max_receipt_date=max_receipt_date, request_type=request_type, office=office, per_page=per_page, cycle=cycle, primary_general_indicator=primary_general_indicator)
    pprint(api_response)
except ApiException as e:
...
# **filings_get**
> FilingsPage filings_get(api_key, filer_type=filer_type, sort_null_only=sort_null_only, form_type=form_type, sort_hide_null=sort_hide_null, state=state, is_amended=is_amended, committee_type=committee_type, district=district, most_recent=most_recent, committee_id=committee_id, sort_nulls_last=sort_nulls_last, beginning_image_number=beginning_image_number, form_category=form_category, report_type=report_type, party=party, report_year=report_year, min_receipt_date=min_receipt_date, sort=sort, amendment_indicator=amendment_indicator, page=page, document_type=document_type, file_number=file_number, max_receipt_date=max_receipt_date, request_type=request_type, office=office, per_page=per_page, cycle=cycle, candidate_id=candidate_id, primary_general_indicator=primary_general_indicator)
...
try:
    api_response = api_instance.filings_get(api_key, filer_type=filer_type, sort_null_only=sort_null_only, form_type=form_type, sort_hide_null=sort_hide_null, state=state, is_amended=is_amended, committee_type=committee_type, district=district, most_recent=most_recent, committee_id=committee_id, sort_nulls_last=sort_nulls_last, beginning_image_number=beginning_image_number, form_category=form_category, report_type=report_type, party=party, report_year=report_year, min_receipt_date=min_receipt_date, sort=sort, amendment_indicator=amendment_indicator, page=page, document_type=document_type, file_number=file_number, max_receipt_date=max_receipt_date, request_type=request_type, office=office, per_page=per_page, cycle=cycle, candidate_id=candidate_id, primary_general_indicator=primary_general_indicator)
    pprint(api_response)
except ApiException as e:
...
# **operations_log_get**
> OperationsLogPage operations_log_get(api_key, sort_null_only=sort_null_only, max_coverage_end_date=max_coverage_end_date, form_type=form_type, sort_hide_null=sort_hide_null, max_transaction_data_complete_date=max_transaction_data_complete_date, candidate_committee_id=candidate_committee_id, min_coverage_end_date=min_coverage_end_date, min_transaction_data_complete_date=min_transaction_data_complete_date, beginning_image_number=beginning_image_number, sort_nulls_last=sort_nulls_last, report_type=report_type, report_year=report_year, min_receipt_date=min_receipt_date, status_num=status_num, sort=sort, amendment_indicator=amendment_indicator, page=page, max_receipt_date=max_receipt_date, per_page=per_page)
...
try:
    api_response = api_instance.operations_log_get(api_key, sort_null_only=sort_null_only, max_coverage_end_date=max_coverage_end_date, form_type=form_type, sort_hide_null=sort_hide_null, max_transaction_data_complete_date=max_transaction_data_complete_date, candidate_committee_id=candidate_committee_id, min_coverage_end_date=min_coverage_end_date, min_transaction_data_complete_date=min_transaction_data_complete_date, beginning_image_number=beginning_image_number, sort_nulls_last=sort_nulls_last, report_type=report_type, report_year=report_year, min_receipt_date=min_receipt_date, status_num=status_num, sort=sort, amendment_indicator=amendment_indicator, page=page, max_receipt_date=max_receipt_date, per_page=per_page)
    pprint(api_response)
except ApiException as e:
